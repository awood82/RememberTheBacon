...
import com.digitalwood.rememberthebacon.common.datastore.ListStoreParse;
 ...
 * Copyright 2014
 */
public class ListStoreParseUnitTest extends AndroidTestCase {
    ...
    public void testAdd_IfSucceeds_CallbackReturnsTrue() {
        IListStore store = getListStoreInstance();
